...
- **음성 판단 기록** — 음성 명령을 고치기 위해 TypeSafe로 보낸 말과 판단 결과를 이 기기에
  남기고, 사용자 본인의 iCloud Drive `초키보드` 폴더 안 `판단기록` 폴더에 사본을 둡니다(개발자에게
  가지 않습니다). 테스트 빌드(TestFlight)에서는 기본으로 켜져 있고 App Store 판에서는 꺼져 있습니다.
